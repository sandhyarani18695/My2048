	...
	document.getElementById("canvas").style.fontWeight=700;
	document.getElementById("canvas").style.fontSize="26px";
	var excludeIds = [];
	function load() {
		//alert("load");
		//Load the table
		var html = '<table border="5px groove #55565a" >';
		for(var row=0;row<size;row++) {
			html += '<tr>';
			for(var col=0;col<size;col++) {
				var id = row+""+col;
                html += '<td align="center" valign="center" height="100" width="100" style="background-color:black" id="'+id+'"></td>';
			}
			html += '</tr>';
		}
		html += '</table>';
